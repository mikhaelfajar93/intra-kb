...
<head>
    ...
    <title>Dashboard - KB Valbury | File Intranet</title>
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @yield('dboard_active')" aria-current="page" href="/">
                            <i class="icon">
                    ...
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="#" tabindex="-1">
                            <span class="default-icon">Division</span>
                            <span class="mini-icon">-</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @yield('comp_active')" data-bs-toggle="collapse" href="#sidebar-widget-comp"
                            ...
                            <span class="item-name">Compliance</span>
                            <i class="right-icon">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-widget-comp" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link @yield('comp_u_active')" href="/comp-upload">
                                    <i class="icon">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @yield('comp_l_active')" href="/comp-list">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-widget-hrd" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @yield('hrd_l_active')" href="/hrd-list">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-widget-it" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @yield('it_l_active')" href="/it-list">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-widget-legal" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @yield('legal_l_active')" href="/legal-list">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
        ...
        <div class="position-relative iq-banner">
                            ...
                            <li class="nav-item dropdown">
                                <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown"
                                    ...
                                    <div class="caption ms-3 d-none d-md-block ">
                                        <h6 class="mb-0 caption-title">Mikhael Fajarjati</h6>
            ...
            <div class="iq-navbar-header" style="height: 215px;">
                ...
                <div class="iq-header-img">
                    <img src="{{ asset('hopeui/assets/images/dashboard/top-header2.png') }}" alt="header"
